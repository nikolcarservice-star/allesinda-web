        ...
        if (center) {
          return (
            ...
            >
              <span
                className={cn(
                  "brand-icon-btn flex h-[52px] w-[52px] items-center justify-center rounded-full shadow-[0_4px_14px_rgba(0,0,0,0.12)]",
                  active && "ring-2 ring-primary/35 ring-offset-2 ring-offset-white",
                )}
              >
                <Plus className="h-7 w-7 text-primary brand-glyph-stroke" strokeWidth={2.5} aria-hidden />
              </span>
