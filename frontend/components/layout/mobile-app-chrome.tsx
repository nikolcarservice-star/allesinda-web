        ...
        if (center) {
          return (
            ...
            >
              <span
                className={cn(
                  "flex h-[52px] w-[52px] items-center justify-center rounded-full bg-primary brand-surface-stroke shadow-[0_4px_14px_rgba(38,173,166,0.45)] transition-transform active:scale-95",
                  active && "ring-2 ring-primary/30 ring-offset-2 ring-offset-white",
                )}
              >
                <Plus className="h-7 w-7 text-black brand-glyph-stroke" strokeWidth={2.5} aria-hidden />
              </span>
