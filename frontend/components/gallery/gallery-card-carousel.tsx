    ...
    <div className={cn("relative w-full", containerClassName)}>
      ...
      >
        {items.map((item, index) => {
          ...
          // Responsive card widths - same as HorizontalCardCarousel
          const cardWidth = "w-[calc(50%-0.375rem)] sm:w-[calc(33.333%-0.375rem)] md:w-[calc(25%-0.375rem)] lg:w-[calc(20%-0.375rem)] xl:w-[calc(16.666%-0.375rem)]"
          ...
          return (
            ...
            >
              <GalleryCard
                item={item}
                href={href}
                onVideoClick={item.media_type === "video" ? onVideoClick : undefined}
