  ...
  return (
    <div className="flex flex-col justify-between h-full overflow-hidden">
      <CartContainer className="flex justify-between text-sm text-muted-foreground">
        <span>Produkt</span>
        <span>{cart.lines.length} Artikel</span>
      </CartContainer>
...
export default function CartModal() {
  ...
  return (
    <>
      <Button aria-label="Warenkorb öffnen" onClick={openCart} className="uppercase" size={'sm'}>
            ...
            >
              <div className="flex flex-col py-3 w-full rounded bg-muted md:py-4">
                <CartContainer className="flex justify-between items-baseline mb-10">
                  ...
                  <Button size="sm" variant="ghost" aria-label="Warenkorb schließen" onClick={closeCart}>
                    Close
                  </Button>
                </CartContainer>
